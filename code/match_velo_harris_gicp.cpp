...
int main(int argc, char** argv) {
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr velo_frame1_in_cam0_frame_ptr = loadVelFrameInCamiRef(1);
...
//    pcl::StopWatch watch;
    ...
    pcl::GeneralizedIterativeClosestPoint<pcl::PointXYZI,pcl::PointXYZI>::MatricesVector keypoints_frame0_cov;
    for (int i = 0; i < keypoints_frame0_ptr->size(); ++i)
    {
        keypoints_frame0_cov.push_back(Eigen::Matrix3f::Identity());
    }
...
//        pcl::console::print_warn ("Keypoints indices are empty!\n");
    ...
    detector.setInputCloud (velo_frame1_in_cam0_frame_ptr);
...
//    pcl::visualization::PCLVisualizer viewer("3D Viewer");
//    viewer.setBackgroundColor(1, 1, 1);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> frame1_cam0_color_handler(velo_frame1_in_cam0_frame_ptr, 255,
                                                                                                                0, 0);
    viewer.addPointCloud(velo_frame1_in_cam0_frame_ptr, frame1_cam0_color_handler, "frame 1");
